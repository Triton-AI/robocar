...
void TransformHelper::do_transform(
  const ttl::Position & in, ttl::Position & out,
  const geometry_msgs::msg::TransformStamped & transform)
{
  const auto in_3d = ttl::Position3d{in.x, in.y, 0.0};
  auto out_3d = ttl::Position3d();
...
void TransformHelper::do_transform(
  const ttl::Position3d & in, ttl::Position3d & out,
  const geometry_msgs::msg::TransformStamped & transform)
{
