...
#ifndef F1TENTH_REGULATED_PURE_PURSUIT_CONTROLLER__HPP_
#define F1TENTH_REGULATED_PURE_PURSUIT_CONTROLLER__HPP_
...
namespace f1tenth_nav2_controller_plugin_namespace_name
{

/**
 * @class f1tenth_nav2_controller_plugin_namespace_name::RegulatedPurePursuitController
...
public:
  /**
   * @brief Constructor for f1tenth_nav2_controller_plugin_namespace_name::RegulatedPurePursuitController
   */
  RegulatedPurePursuitController() = default;

  /**
   * @brief Destrructor for f1tenth_nav2_controller_plugin_namespace_name::RegulatedPurePursuitController
   */
...
#endif  // F1TENTH_REGULATED_PURE_PURSUIT_CONTROLLER__HPP_