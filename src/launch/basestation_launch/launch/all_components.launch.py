...
car_parameter_input_path = os.path.join(launch_file_path, '../param/car_config.yaml') # '/home/jetson/projects/robocar/src/launch/basestation_launch/param/car_config.yaml'
